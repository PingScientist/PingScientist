...
Copy the contents of this folder into the root of the public GitHub profile repository:

```text
PingScientist/PingScientist
```

Then replace this placeholder in `README.md`:
